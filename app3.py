...
def main():
    with st.sidebar:
        ...
        selected = option_menu('  MediSense AI',
...
st.write("\n")
st.write("\n")
st.markdown('<p style="font-size:12px; color:#808080;">"© 2026 MediSense AI | Developed by Mudavath Srikanth"</p>', unsafe_allow_html=True)
